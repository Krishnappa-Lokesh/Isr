sap.ui.define([
	...
	return BaseObject.extend("psu.isr.Isr.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias psu.isr.Isr.model.ListSelector
		 */
		 ...
		 * @return {psu.isr.Isr.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
