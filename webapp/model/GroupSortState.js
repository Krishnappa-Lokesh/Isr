sap.ui.define([
	...
	return BaseObject.extend("psu.isr.Isr.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias psu.isr.Isr.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "Zz1Isrno");
			}
