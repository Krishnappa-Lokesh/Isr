sap.ui.define([
	"psu/isr/Isr/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("Zz1Isrno").length, 1, "The sorting by Zz1Isrno returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by Zz1Isrno and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("Zz1Isrno");
