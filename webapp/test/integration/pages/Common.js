sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("psu/isr/Isr/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#InternalServiceRequest-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#InternalServiceRequest-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("psu.isr.Isr.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["psu/isr/Isr/localService/mockserver"], function (mockserver) {
